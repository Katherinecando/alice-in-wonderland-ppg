...
minParticipants = 15;        % for mean Â± SD
...
for k = 1:numel(files)
    ...
    fname = fullfile(files(k).folder, files(k).name);   % â full path always
    ...
    % â lock participant index so HR and HRV arrays stay aligned
