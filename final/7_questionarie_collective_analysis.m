...
% fprintf('Engagement mean = %.2f Â± %.2f\n', mean_eng, sd_eng);

% fprintf('Performance rating mean = %.2f Â± %.2f\n', mean_perf, sd_perf);
...
% Figure 1: Engagement + Performance mean Â± SD
...
ylabel('Score'); title('Questionnaire ratings (mean Â± SD)');
